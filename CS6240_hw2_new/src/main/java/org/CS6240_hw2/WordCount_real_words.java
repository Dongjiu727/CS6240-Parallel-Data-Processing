...
public class WordCount_real_words {
    ...
    public static class TokenizerMapper
        ...
        /**
         * Maps each input key/value pair to (word, 1) pairs if the word starts with the specified letters.
    ...
    /**
     * Add custom partitioner to the program.
     * Partitions the output based on the starting letter of the word.
     */
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(WordCount_real_words.class);
