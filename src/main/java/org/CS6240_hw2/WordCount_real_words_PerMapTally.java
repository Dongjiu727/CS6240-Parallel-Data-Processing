...
public class WordCount_real_words_PerMapTally {
    ...
    public static class TokenizerMapper
        ...
        public void map(Object key, Text value, Context context
            ...
            // Initialize a HashMap to tally word counts.
            ...
            // Emit (word, count) pairs from the accumulated word counts
    ...
    public static void main(String[] args) throws Exception {
        ...
        job.setJarByClass(WordCount_real_words_PerMapTally.class);
