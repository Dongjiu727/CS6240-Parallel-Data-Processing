...
-- FILTER data BY Flight 1 year, Flight 1 month and Flight 2 year, Flight 2 month in the range
F1F2_pairs = FILTER F1F2_time BY ((year1 == 2007 AND month1 >= 6) OR
                                  (year1 == 2008 AND month1 <= 5 AND year2 == 2007 AND month2 >= 6) OR
                                  (year2 == 2008 AND month2 <= 5));
